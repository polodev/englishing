 ...
 *
 * Eloquent models dispatch several events, allowing you to hook into
 * the following moments in a model's lifecycle: retrieved, creating,
 * created, updating, updated, saving, saved, deleting, deleted, trashed,
...
namespace Modules\Utility\Libraries\Traits;
