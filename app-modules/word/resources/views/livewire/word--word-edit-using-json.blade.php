    ...
    <div class="fixed inset-0 overflow-y-auto px-4 py-6 sm:px-0 z-50">
        ...
        <div class="mb-6 bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full sm:max-w-4xl mx-auto">
            ...
            <div class="px-6 py-4 bg-gray-100 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 flex justify-between items-center">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white">Edit Word JSON</h3>
            ...
            <div class="p-6 dark:bg-gray-800">
                ...
                <!-- JSON Editor -->
                <div class="mb-4">
                    <label for="jsonData" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Edit JSON Data
                    </label>
                    <textarea
                        id="jsonData"
                        wire:model="jsonData"
                        rows="20"
                        class="w-full px-3 py-2 text-gray-700 dark:text-gray-300 border rounded-lg focus:outline-none bg-white dark:bg-gray-700 font-mono text-sm"
