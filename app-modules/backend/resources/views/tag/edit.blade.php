<x-ui-backend::layout>
    <div class="container mx-auto px-4 py-6">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Tag: {{ $tag->title }}</h1>
        </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="title" name="title" value="{{ old('title', $tag->title) }}" required 
                    ...
                    <div class="mb-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="title_translation_bn" name="title_translation[bn]" 
                                       value="{{ old('title_translation.bn', $tag->getTranslation('title_translation', 'bn', false)) }}" 
                                       class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="title_translation_hi" name="title_translation[hi]" 
                                       value="{{ old('title_translation.hi', $tag->getTranslation('title_translation', 'hi', false)) }}" 
                                       class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Check if slug has been manually modified
