<x-ui-backend::layout>
    <x-slot:title>Create Article Double Word Set</x-slot:title>
    <div class="container mx-auto px-4 py-6">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-200">Create New Article Double Word Set</h1>
        </div>

        <!-- Form -->
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
            <form action="{{ route('backend::article-double-word-sets.store') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="mt-8 flex justify-end">
                    <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        <i class="fas fa-save mr-2"></i> Save Double Word Set
                    </button>
                </div>
            </form>
        </div>
