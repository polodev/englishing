...
<script>
    function deleteList(id) {
        if (confirm('Are you sure you want to delete this triple word list? This action cannot be undone.')) {
            // Send a DELETE request to remove the list
            fetch(`/dashboard/article-triple-word-list/${id}`, {
                method: 'DELETE',
                headers: {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    alert('Failed to delete the triple word list.');
                }
            })
            .catch(error => {
                console.error('Error:', error);
                alert('An error occurred while deleting the triple word list.');
            });
        }
    }
</script>
