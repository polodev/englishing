<x-ui-backend::layout>
    <x-slot:title>Article Triple Word Sets</x-slot:title>
    <div class="container mx-auto px-4 py-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-200">Article Triple Word Sets</h1>
            <a href="{{ route('backend::article-triple-word-sets.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
            <div class="p-4">
                <table id="article-triple-word-sets-table" class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
    ...
    <script>
        $(document).ready(function() {
            let table = $('#article-triple-word-sets-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{ route("backend::article-triple-word-sets.index_json") }}',
                    data: function (d) {
