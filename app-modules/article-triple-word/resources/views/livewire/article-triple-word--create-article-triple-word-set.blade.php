...
new class extends Component {
    ...
    public function mount($articleId = null)
    {
        ...
        if ($this->articleId) {
            ...
            $lastSet = ArticleTripleWordSet::where('article_id', $this->articleId)
    ...
    // Create a new article triple word set
    public function createArticleTripleWordSet()
    {
        if (!$this->articleId) {
            session()->flash('error', 'No article selected. Please select an article first.');
            return;
        ...
        // Create the article triple word set
        $set = ArticleTripleWordSet::create([
        ...
        $this->dispatch('article-triple-word-set-created', ['articleId' => $this->articleId]);
    }
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-green-700 dark:text-green-200">
                                    Triple Word Set "{{ $createdSetTitle }}" has been created successfully!
                                </p>
                            </div>
                        </div>
                    </div>
